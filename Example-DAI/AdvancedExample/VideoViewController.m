...
- (void)requestStream {
    ...
    IMAAdDisplayContainer *adDisplayContainer = [[IMAAdDisplayContainer alloc] initWithAdContainer:self.videoView viewController:self];
        ...
        case kIMAAdEvent_STREAM_LOADED: {
            if (self.video.streamType == StreamTypeVOD) {
                ...
                if (self.video.savedTime > 0) {
                    NSTimeInterval streamTime = [self.streamManager streamTimeForContentTime:self.video.savedTime];
